...
(() => {
  ...
  const revealTargets = document.querySelectorAll('.intro, .trust, .services, .gallery, .hydro, .about, .finalcta, .service-list, .pricing, .faq, .cta-panel, .gallery-full, .team, .contact, .location');
